 ...
 * @author zapo
 */
public class UserUpgrade extends javax.swing.JDialog {

    private int dias;
    private boolean valido;
    
    public UserUpgrade(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jRB3.setText("3 meses / 13.99€");

        jRB5.setText("5 meses / 19.99€");
        ...
        jLabel1.setText("Elije la opcion que prefieras");

        jLabel2.setFont(new java.awt.Font("Lao UI", 3, 36)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(0, 0, 204));
        jLabel2.setText("Mejorar subscripcion");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserUpgrade.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                UserUpgrade dialog = new UserUpgrade(new javax.swing.JFrame(), true);
